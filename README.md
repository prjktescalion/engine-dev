<p align="center">
  <img src="./.github/logo.png" alt="Project Escalion icon" width="128" height="128">
</p>

<h1 align="center">Project Escalion</h1>
...
**Project Escalion** is two things:
...
2. **A studio editor** — a desktop app where you place assets on a canvas, build scenes, and forward your scripts straight to whatever editor you use (VS Code, JetBrains, anything). Also pure Rust — UI is [GPUI](https://www.gpui.rs/).
